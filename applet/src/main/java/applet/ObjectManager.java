...
public class ObjectManager {
     ...
     *
     * @param mem_ref The MemoryManager object to be used to allocate objects'
     *                memory.
     */
     ...
     * @param id         Object ID (Type and ID form a generic 4 bytes identifier)
     ...
     * @param type     Object Type
     * @param id       Object ID (Type and ID form a generic 4 bytes identifier)
     * @param new_size The new object size (must be less than current size)
     ...
     *
     * @param base       The object base address as returned from getBaseAddress()
     ...
     * @param type   Object Type
     * @param id     Object ID (Type and ID form a generic 4 bytes identifier)
     * @param secure If true, object memory is zeroed before being released.
     */
     ...
     * @param offset The offset in buffer[] at which the record will be copied
