...
public class MemoryManager {
     ...
     *
     * @param offset The offset at which the memory block starts; it was returned
     ...
     *
     * @param dst_base   The base memory location (offset) of the destination byte
     *                   sequence
     * @param dst_offset The offset of the destination byte sequence (is added to the
     *                   dst_base parameter)
     ...
     * @param src_offset The offset of the source byte sequence (is added to the
     *                   src_base parameter)
     * @param size       The number of bytes to be copied
     */
